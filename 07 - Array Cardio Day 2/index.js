...
const isAdultPerson = people.some((person) => currentYear - person.year >= 19);
console.log("At least one person older than 19: " + isAdultPerson);
...
console.log("find the comment with the ID of 823423: " + commentById.text);
